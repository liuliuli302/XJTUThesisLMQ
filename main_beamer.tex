...
\title[% 页脚标题[非首页]
  基于层级语义建模与多智能体协同推理的免训练视频摘要方法
]{% 主标题[首页]
  \textbf{基于层级语义建模与多智能体\\协同推理的免训练视频摘要方法}
}

\subtitle{% 子标题[首页]
  Training-free Video Summarization via Hierarchical Semantic Modeling \\and Multi-agent Collaborative Reasoning
}
