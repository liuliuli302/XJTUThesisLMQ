...
\documentclass[
    ...
    % fancyemptypage,   % 可选项：   开启后，为确保章节在奇数页开始而插入的空白页，将显示页眉与页码
                        %            (*根据要求，标题页与答辩委员页会始终不显示页眉与页码)
                        % Optional:  Controlling whether the inserted empty page will show header and page number.
                        %            Title page and Defense Committee page will not be affected by this option, 
                        %            they will always not show header and page number.
]{XJTU-thesis}
...
\title{基于层级语义建模与多智能体协同推理的免训练视频摘要方法}{Training-free Video Summarization via Hierarchical Semantic Modeling and Multi-agent Collaborative Reasoning}
...
% Type of your degree, Translate it from documents in `Materials/Requirements/2025/01 中英文题名页示例/英文标准翻译/'
...
% 学术型学位请按 '附件1：学位论文题名页学科名称目录（学术型博士、硕士）.xlsx' 填写学科名称
% 专业型学位请按 '附件2：学位论文题名页类别（领域）名称目录（专业型博士、硕士）.xlsx' 填写类别（领域）名称
% 英文翻译请基于 '学科（专业）英文标准翻译.pdf' 或 '专业学位（领域）英文标准翻译.pdf' 填写
% Name of the subject, fill it according to Attachment 1 or Attachment 2 under
% 'Materials/Requirements/2025/01 中英文题名页示例/', and translate it with the
% files under '英文标准翻译/'
...
\addcommitteemember{西安交通大学,田智强,教授}
\addcommitteemember{西安交通大学,徐亦飞,副教授}
\addcommitteemember{西安交通大学,薛尧,副教授}
\addcommitteemember{西安交通大学,王玲,教授}

% 答辩时间（手动指定）
% Defence date, input manually
\defensedate{2026}{04}{02}

% 答辩地点（涉密论文请手动设置为「西安交通大学」）
% Defence location, default value is 「西安交通大学」
\defenseloc{中国西部科技创新港4-3204}

% 常规审阅人 要求和答辩委员会委员一样
% General reviewer list, same requirements as the committee member
\addgeneralreviewer{西安交通大学,田智强,教授}
\addgeneralreviewer{西安交通大学,徐亦飞,副教授}
\addgeneralreviewer{西安交通大学,薛尧,副教授}
\addgeneralreviewer{西安交通大学,王玲,教授}
